 ...
 * Permite a los nuevos usuarios crear una cuenta proporcionando sus datos personales.
 * La ventana incluye campos para nombre de usuario, correo electrónico y contraseña,
 * así como validación básica de los datos ingresados.
 * 
 * @author [Diego Capellán Fernández y Alejadro Hernández Murga]
 * @version 1.0
 */
public class Ventana_Registro_2 extends JFrame {
    ...
    /**
     * Método principal que inicia la aplicación y muestra la ventana de registro.
     * Establece la conexión con la base de datos antes de mostrar la interfaz gráfica.
     * 
    ...
    /**
     * Constructor que crea e inicializa la ventana de registro.
     * Configura todos los componentes gráficos y establece los listeners de eventos.
     * 
     * @param cn Objeto de conexión a la base de datos que se utilizará para registrar usuarios
     */
    public Ventana_Registro_2(ClaseConexion cn) {
         ...
         * Recoge los datos ingresados por el usuario, los valida y los envía a la base de datos.
